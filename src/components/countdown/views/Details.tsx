...
export default function CountdownDetails() {
  ...
  // const event = {} as IScheduleEvent;
  return (
    <div>
      <div>
        <div className='flex align-center margin-top-two'>
          <Button className='common-button' href='http://localhost:3000/coutdown/list' type="default" size='large' shape="round">
        ...
        <Row>
          ...
          <Col span={4} className='flex justify-right'>
            <Button className='common-button flex justify-center flex align-center' type="default" size='large' shape="circle">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <g clipPath="url(#clip0_67_690)">
      ...
      <div className='timeline-row'>
        <Row className='flex align-center flex-row'>
          <Col span={4}>
            <div className='schedule-container margin-top-mthree'>
              <Paragraph className="text-subtitle margin-top-five text-white">{"LLM1"}</Paragraph>
            </div>
          </Col>
          <div className='margin-top-mthree schedule-divider'></div>
          <Col span={3}>
            <Paragraph className="text-bigcontent text-common">{"Queue"}</Paragraph>
            <Paragraph className="text-subtitle margin-top-mtwo text-white">{"09 : 45"}</Paragraph>
          </Col>
          <div className='margin-top-mthree schedule-divider'></div>
          <Col span={3}>
            <Paragraph className="text-bigcontent text-common">{"In Time"}</Paragraph>
            <Paragraph className="text-subtitle margin-top-mtwo text-white">{"09 : 50"}</Paragraph>
          </Col>
          <div className='margin-top-mthree schedule-divider'></div>
          <Col span={3}>
            <Paragraph className="text-bigcontent text-common">{"Out Time"}</Paragraph>
            <Paragraph className="text-subtitle margin-top-mtwo text-white">{"10 : 10"}</Paragraph>
          </Col>
          <div className='margin-top-mthree schedule-divider'></div>
          <Col span={3}>
            <Paragraph className="text-bigcontent text-common">{"Late Time"}</Paragraph>
            <Paragraph className="text-subtitle margin-top-mtwo text-white">{"10 : 45"}</Paragraph>
          </Col>
        </Row>
        <div className='schedule-divider-down'>
          <Paragraph className="text-content margin-top-two">
            <Paragraph className="text-bigcontent text-common">{"Countdown"}</Paragraph>
          </Paragraph>
          <Row className='justify-between'>
            <Col span={7}>
              <div className='flex justify-center'>
                <div className='counter'>
                  <Paragraph className="text-title margin-top-five text-white">1</Paragraph>
                </div>
                <div className='counter margin-left'>
                  <Paragraph className="text-title margin-top-five text-white">2</Paragraph>
                </div>
              </div>
            </Col>
            <div className='flex justify-center'>
              <Paragraph className="text-subtitle margin-top-five text-white">:</Paragraph>
            </div>
            <Col span={7}>
              <div className='flex justify-center'>
                <div className='counter'>
                  <Paragraph className="text-title margin-top-five text-white">5</Paragraph>
                </div>
                <div className='counter margin-left'>
                  <Paragraph className="text-title margin-top-five text-white">9</Paragraph>
                </div>
              </div>
            </Col>
            <div className='flex justify-center'>
