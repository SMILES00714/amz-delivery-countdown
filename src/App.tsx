...
import CountDetails from "./components/countdown/views/Details";
import CountList from "./components/countdown/views/List";
import CreateEvent from "./components/event/views/Add";
import Day from "./components/week/views/Day";
import EventDetails from "./components/event/views/Details";
import EventList from "./components/event/views/List";
import Navbar from "./components/shared/navbar/Navbar";
import Week from "./components/week/views/Week";
